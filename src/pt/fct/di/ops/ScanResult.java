...
public class ScanResult implements IResult{
	
	private final int RESULT_TYPE = 7;
...
//	private int _type; //Changed from String to Integer because we know all types from starter and can attribute a number. This saves space.
	...
	private int _code;
	private Vector<Map<String,String>> _values; //in the case code < 0 an error message will be put here.
	private String _msg;
	private long[] _versionVector; //Changed from timestamp to store the version vector.
	
	public ScanResult(int code)
	{
		this._opSeq = 0;
		this._code = code;
		this._values = null;
	...
	public ScanResult(int code, Vector<Map<String,String>> values)
	{
		this._opSeq = 0;
		this._code = code;
		this._values = values;
	...
	public ScanResult(int code, String msg)
	{
		this._opSeq = 0;
		this._code = code;
		this._values = null;
	...
	public ScanResult(ObjectInputStream ois) throws IOException, ClassNotFoundException
	{
		deserialize(ois);
	}
	...
	public void setValues(Vector<Map<String,String>> values)
	{
	...
	public Vector<Map<String,String>> getValues()
	{
		return this._values;
	}
	...
	private void writeValues(ObjectOutputStream oos) throws IOException
	{
		...
		for(Map<String, String> map: _values)
		{
	...
	private void readValues(ObjectInputStream ois) throws IOException
	{
		...
		_values = new Vector<Map<String,String>>(vectorSize);
		Map<String,String> map = null;
	
		for(int elems=0; elems<vectorSize; elems++)
		{
			mapSize = ois.readInt();
			map = new HashMap<String,String>(mapSize);
